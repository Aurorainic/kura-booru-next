...
// No-query state: surface recent searches (localStorage) + popular tags to encourage exploration.
...
<template>
  <div class="max-w-[var(--content-max)] mx-auto px-4 lg:px-8 py-4" style="padding-top: var(--space-page-top);">
    <!-- Compact header with active query; the no-query state has its own centered 60% search surface -->
