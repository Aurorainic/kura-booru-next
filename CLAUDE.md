...
- **Contract freeze**: 59 endpoints are frozen in `server/platform/contract/endpoints.ts`. Run `npm run test:contract` (or `node server/platform/contract/check.mjs`) after any route file change. CI gates this.
